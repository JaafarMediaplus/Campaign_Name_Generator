...
product_variant = colproductvariant.selectbox(
    ...
    'Alenza', 'MarPost1', 'MarPost2','MarPost3', 'MarPost4', 'MarPost5', 'ConsGoods', 'SMEfleet', 'Story1', 'Story2', 'Story3', 'Story4', 'MG', 'Biban', 'ToyotaSedan', 'ToyotaRush')
)
...
format = colformat.selectbox(
    ...
    'Expended', 'Gmail', 'Discovery', 'HTML5', 'StaticDisplay', 'Multiple', 'DSCVRYAd', 'DSCVRYCarouselAd', 'Banner', 'SkippableAd', 'TextAds')
)
...
elif product == 'SMEfleet':
    coded_product = product.replace('SMEfleet', 'P036')
else:
